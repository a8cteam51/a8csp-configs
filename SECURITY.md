...
Use releases, not `trunk`, as [the README](README.md#versioning) describes. [CONTRIBUTING.md](CONTRIBUTING.md) holds the backwards-compatibility and release contract.
